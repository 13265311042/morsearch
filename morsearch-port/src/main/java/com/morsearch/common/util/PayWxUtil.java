...
import com.morsearch.common.util.PayMD5Util;
...
public class PayWxUtil {
    ...
    public static String createSign(String characterEncoding,SortedMap<String,Object> parameters){
        ...
        sb.append("key=" + PayWxController.API_KEY);
        String sign = PayMD5Util.MD5Encode(sb.toString(), characterEncoding).toUpperCase();
        return sign;
    }
    //请求方法
