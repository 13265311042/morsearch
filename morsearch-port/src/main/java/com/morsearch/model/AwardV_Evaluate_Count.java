...
public class AwardV_Evaluate_Count {
    private Long sc_id;
    ...
    public String getAppraisephone() {
        return appraisephone;
    }

    public void setAppraisephone(String appraisephone) {
        this.appraisephone = appraisephone;
    }
}