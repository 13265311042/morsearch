...
public class UserPerfect {
    ...
    private Base_LableList_list ue_willworkage;/*从业年限*/
    private Base_LableList_list barndlist;/*品牌*/


    public Base_LableList_list getUe_willworkage() {
        return ue_willworkage;
    }

    public void setUe_willworkage(Base_LableList_list ue_willworkage) {
        this.ue_willworkage = ue_willworkage;
    }
    ...
    public Base_LableList_list getBarndlist() {
        return barndlist;
    }

    public void setBarndlist(Base_LableList_list barndlist) {
        this.barndlist = barndlist;
    }
}
