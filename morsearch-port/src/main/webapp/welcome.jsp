<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="col-md-12">
		...
		<table>
		<tr>
		<td align="center" colspan="2"><h1>蓝缘系统</h1></td>
		</tr>
		<tr>
		<td><div class="topBtn" style="font-size: 15px;">
								...
								<div style="padding-left: 20px;">
									...
									优化：
									<div style="padding-left: 20px;color: blue;padding-top: 10px;font-size: 20px">
									      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;集成SSM框架为基础的一套后台系统,系统对JAVA的封装,多态,继承特性做了充分的运用.最显著的功能是:对于基本的<font color="red">增,删,改,查</font>的功能,不需要写<font color="red">任何SQL语句</font>,代码<font color="red">一键调用</font>即可.具有很好的<font color="red">灵活性,方便性,快速性.这样就大大减少代码开发时间,提高开发效率</font>,为企业或个人有效率地节约人力资源的成本!
									</div>
									...
									3.2版本不再使用spring Security3权限安全机制,采用了shiro权限机制,
